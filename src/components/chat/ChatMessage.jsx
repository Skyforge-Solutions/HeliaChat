            ...
            <div className="mt-1 text-gray-700 dark:text-gray-300 prose dark:prose-invert">
              ...
              {!isUser && (
                <div className="mt-2 flex gap-3 text-gray-500 dark:text-gray-400 text-sm">
                  <button onClick={copyToClipboard} className="hover:text-gray-700 dark:hover:text-gray-200 transition-colors">
                    <FiCopy />
                  </button>
                  <button onClick={readAloud} className="hover:text-gray-700 dark:hover:text-gray-200 transition-colors">
                    <FiVolume2 />
                  </button>
                  <button
                    onClick={toggleUp}
