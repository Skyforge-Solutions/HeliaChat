      ...
      <div className='max-w-6xl mx-auto px-4 py-12'>
        <div className='text-center mb-12'>
          ...
          <p className='text-muted-foreground mt-2 max-w-xl mx-auto'>
            Purchase credits to continue your conversations with Helia. Choose the package that best fits your needs.
          </p>
        </div>
            ...
            <div className='pt-4'>
              ...
              >
                {isProcessing ? (
                  ...
                  `Pay $${creditPackages.find(pkg => pkg.id === selectedPackage)?.price}`
                )}
              </button>
            </div>
          </form>
